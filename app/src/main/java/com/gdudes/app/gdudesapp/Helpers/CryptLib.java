...
public class CryptLib {
    ...
    static String SecretKey = "GDS06Apr2015@sim@19111911sim";
    ...
    public CryptLib() throws NoSuchAlgorithmException, NoSuchPaddingException, UnsupportedEncodingException {
        // initialize the cipher with transformation AES/CBC/PKCS5Padding
        _cx = Cipher.getInstance("AES/CBC/PKCS5Padding");
        _key = new byte[32]; //256 bit key space
        _iv = new byte[16]; //128 bit IV
        _encryptionKey = SHA256(); //32 bytes = 256 bit
    }
     ...
     */
    private String encryptDecrypt(String _inputText, EncryptMode _mode, String _initVector) throws UnsupportedEncodingException,
     ...
     * @throws UnsupportedEncodingException
     */
    public String SHA256() throws NoSuchAlgorithmException, UnsupportedEncodingException {
    ...
    public String encrypt(String _plainText, String _initVector)
            throws InvalidKeyException, UnsupportedEncodingException,
            InvalidAlgorithmParameterException, IllegalBlockSizeException,
            BadPaddingException {
        try {
            //return StringEncoderHelper.encodeURIComponent(encryptDecrypt(_plainText, EncryptMode.ENCRYPT, _initVector));
            return URLEncoder.encode(encryptDecrypt(_plainText, EncryptMode.ENCRYPT, _initVector), "UTF-8");
        } catch (Exception ex) {
            throw ex;
        }
    }
     ...
     * @throws BadPaddingException
     */
    public String decrypt(String _encryptedText, String _initVector)
            throws InvalidKeyException, UnsupportedEncodingException,
            InvalidAlgorithmParameterException, IllegalBlockSizeException,
            BadPaddingException {
        try {
            return encryptDecrypt(_encryptedText, EncryptMode.DECRYPT, _initVector);
        } catch (Exception ex) {
            throw ex;
        }
    }

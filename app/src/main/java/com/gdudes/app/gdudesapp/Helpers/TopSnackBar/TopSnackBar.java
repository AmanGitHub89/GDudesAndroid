package com.gdudes.app.gdudesapp.Helpers.TopSnackBar;
...
public class TopSnackBar {
    ...
    private TopSnackBar(ViewGroup parent) {
        ...
        mView = (SnackbarLayout) inflater.inflate(R.layout.topsnackbar_layout, mParent, false);
    }
    ...
    @NonNull
    public static TopSnackBar MakeSnackBar(@NonNull View view, @NonNull CharSequence text,
                                           @Duration int duration, Boolean IsError) {
        TopSnackBar snackbar = new TopSnackBar(findSuitableParent(view));
        snackbar.setText(text);
        snackbar.setDuration(duration);
        ...
        snackbarView.setBackgroundColor(ContextCompat.getColor(snackbar.mContext, IsError ? R.color.toastError : R.color.colorPrimaryLight));
...
//        return fallback;
    ...
    public TopSnackBar setIconPadding(int padding) {
        final TextView tv = mView.getMessageView();
    ...
    public TopSnackBar setIconLeft(SnackIcon snackIcon) {
        final TextView tv = mView.getMessageView();
        Drawable drawable = ContextCompat.getDrawable(mContext, getIconID(snackIcon));
        if (drawable != null) {
            drawable = fitDrawable(drawable, (int) convertDpToPixel(24, mContext));
        } else {
    ...
    public TopSnackBar setIconRight(@DrawableRes int drawableRes, float sizeDp) {
        final TextView tv = mView.getMessageView();
    ...
    private static int getIconID(SnackIcon snackIcon) {
        switch (snackIcon) {
            case INFO:
    ...
    private void animateViewIn() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            ...
            ViewCompat.animate(mView)
                    .translationY(0f)
                    .setInterpolator(com.gdudes.app.gdudesapp.Helpers.TopSnackBar.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR)
            ...
            Animation anim = AnimationUtils.loadAnimation(mView.getContext(),
                    R.anim.topsnackbar_show);
            anim.setInterpolator(com.gdudes.app.gdudesapp.Helpers.TopSnackBar.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
    ...
    private void animateViewOut(final int event) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            ...
            Animation anim = AnimationUtils.loadAnimation(mView.getContext(), R.anim.topsnackbar_hide);
            anim.setInterpolator(com.gdudes.app.gdudesapp.Helpers.TopSnackBar.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
            anim.setDuration(ANIMATION_DURATION);
            anim.setAnimationListener(new Animation.AnimationListener() {
                @Override
    ...
    public static class SnackbarLayout extends LinearLayout {
        ...
        public SnackbarLayout(Context context, AttributeSet attrs) {
            ...
            LayoutInflater.from(context)
                    .inflate(R.layout.topsnackbar_layout_include, this);
